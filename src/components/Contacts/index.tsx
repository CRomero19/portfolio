          ...
          <motion.div style={{ scale }}>
            <ContactSectionText>
              <Text type="heading2" color="grey4">
                Entre em contato, ficarei feliz em atendê-lo!{" "}
                <Text as="span" type="heading2" color="brand1">
                  Aqui estão alguns meios!
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text
                  ...
                  onClick={() =>
                    (window.location.href = "mailto:ronerodocarmojunior@hotmail.com")
                  }
                >
                  Enviar email
                </Text>
